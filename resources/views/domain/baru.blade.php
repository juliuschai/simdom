	...
	<div class="row justify-content-center">
		<div class="col-md-12 col-sm-12 text-center p-0 mt-3 mb-2">
			<div class="card px-0 pt-4 pb-0 mt-3 mb-3">
				...
				<form id="msform" action="{{route('domain.new')}}" method="POST" enctype="multipart/form-data">
					@csrf
					<!-- progressbar -->
					<ul id="progressbar">
					...
					<fieldset>
						<div class="form-card">
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input id="integraPic" type="text" class="form-control" value="{{$user->integra}}" disabled>
								</div>
							</div>
					...
					<fieldset>
						<div class="form-card">
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input id="namaDomain" type="text" name="namaDomain" value="{{old('namaDomain')}}" class="form-control">
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<unit-select :units="{{$units}}" :tipe-units="{{$tipeUnits}}" :value="{{old('unit')??'1'}}">
									</unit-select>
								</div>
							</div>
							...
							<div class="form-group row">
								<label for="tipeServer" class="col-md-4 col-form-label text-md-left">{{ __('Tipe Server') }}
									<p style="color: red" class="d-inline">*</p></label>
								<i class="fa fa-server domain"></i>
								<div class="col-md-6">
									<select id="tipeServer" name="tipeServer" class="form-control" data-value="{{old('tipeServer')}}">
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input id="kapasitas" type="text" name="kapasitas" value="{{old('kapasitas')??'64'}}"
							...
							<div class="form-group row">
								<label for="sivitas"
									class="col-md-4 col-form-label text-md-left">{{ __('IP Domain') }}</label>
								<i class="fa fa-ellipsis-h domain"></i>
								<div class="col-md-6">
									<input id="sivitas" type="text" class="form-control" value="">
								</div>
							</div>
							@endif --}}

						</div>
						<button type="submit" class="next action-button">Buat</button>
